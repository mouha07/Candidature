...
<div <?php echo implode( ' ', $wrapper_attributes ); ?>
	...
	} ?> vc_icon_element-size-<?php echo esc_attr( $size ); ?> vc_icon_element-style-<?php echo esc_attr( $background_style ); ?> vc_icon_element-background-color-<?php echo esc_attr( $background_color ); ?>" <?php if( !empty($style) ) : ?> style="<?php echo esc_attr( $style ); ?>" <?php endif; ?>>
