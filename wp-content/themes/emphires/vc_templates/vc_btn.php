...
?>
<div class="<?php echo trim( esc_attr( $css_class ) ) ?>" <?php echo esc_attr( implode( ' ', $wrapper_attributes ) ); ?>>
	<?php
	if ( $use_link ) {
		echo cspt_esc_kses('<a ' . $attributes . '><span>' . $button_html . '</span></a>');
	} else {
		echo cspt_esc_kses('<button ' . $attributes . '><span>' . $button_html . '</span></button>');
	}
	?></div>
